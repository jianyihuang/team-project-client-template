...
handlePost(e){
    ...
    var writeRequestText = this.state.value.trim();
      if(writeRequestText !== "" && this.state.type !== 0
        &&this.state.title !== "" && this.state.category !== "Category"){
...
render() {
  ...
  if(this.state.type === 1) {
    categories = ["Computer Science","Math","Music","History","Physics","English"];
  }
  if(this.state.type === 2) {
    categories =  ["Pet Related","Home Improvement","Travel","Yard","Plumer","Car Pool"];
  }
  return(
    <div className="row">
