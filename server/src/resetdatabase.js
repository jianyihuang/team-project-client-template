  ...
  "messageboxes":{
    "1":{
      ...
      "list_of_messages_by_users_in_box":[
          {
          user_id: new ObjectID("000000000000000000000006"), timestamp: 1479148390962, content: 'the current homepage we have wont count as a page. It would make sense that after the user logs in they are directed to the academic or academic subject page but someone is doing those pages already'
          },
          {
          user_id: new ObjectID("000000000000000000000003"), timestamp: 1479148390962, content: 'is the academic page the one with the grids. I know but I gotta study for interview,so im trynna get basic in then improve upon it'
          },
          {
          user_id: new ObjectID("000000000000000000000005"), timestamp: 1479148390962, content: 'how are you guys doing I am considering adding some material design concept in UI'
          },
          {
          user_id: new ObjectID("000000000000000000000004"), timestamp: 1479148390962, content: 'good job, Jucong. You may create a writeup document for the team if you want.'
          },
          {
          user_id: new ObjectID("000000000000000000000005"), timestamp: 1479148390962, content: 'I only have time after 5 tmr'
          },
          {
          user_id: new ObjectID("000000000000000000000004"), timestamp: 1479148390962, content: 'ok ok ok guys, it\'s fine. We\'ll figure this out.'
          },
          {
...
db.collection('feedItems').createIndex({ "contents.contents": "text" }, null, cb);//consider adding contents.request
}
/**
